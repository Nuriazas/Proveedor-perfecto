...
const initDb = async () => {
    try {
        ...
        console.log('Creando base de SkillAgora...');
        ...
        await pool.query(
            'DROP TABLE IF EXISTS users, categories, services, order_deliveries, orders, service_media, reviews, notification, user_portfolio, notification_history'
        );
